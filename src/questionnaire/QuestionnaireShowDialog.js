...
import { Button, Modal, ModalBody, ModalHeader, Form, Label, Col, Input, FormGroup } from 'reactstrap';
    ...
    render() {
        return (
            <div>
                ...
                <Modal isOpen={this.state.showModal} toggle={this.close} size="lg" className="QuestionnaireShowDialog" autoFocus={false} >
